...
function Page() {
    _s();
    /* ---------------------- estado local ---------------------- */ const [jogadores, setJogadores] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    /* ---------------------- carregar jogadores da API ---------------------- */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Page.useEffect": ()=>{
    ...
    const salvarJogador = async (jogador)=>{
        if (jogadorEditando) {
            // Edição local - idealmente aqui faria PUT na API (a implementar)
            setJogadores((prev)=>prev.map((j)=>j.id === jogador.id ? jogador : j));
            fecharModalJogador();
        } else {
            // Novo jogador - salvar na API via POST
            try {
                const res = await fetch('/api/jogadores', {
                    method: 'POST',
                    headers: {
                ...
                if (res.ok) {
                    const novoJogador = await res.json();
                    setJogadores((prev)=>[
                            ...prev,
                            novoJogador
                        ]);
...
_s(Page, "q2hcf8DwzWpAeTA6dA5m+KykPCE=", false, function() {
    return [
...
//# sourceMappingURL=_dd599c88._.js.map